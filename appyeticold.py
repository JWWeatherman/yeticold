...
def YCdisplayseeds():
    ...
    if request.method == 'POST':
        ...
        subprocess.call('touch '+path+'/ycseedpacket'+str(privkeycount + 1)+'/instructions.txt', shell=True)
        file = ''
        for i in range(0,13):
        ...
        subprocess.call('echo "'+pubdesc+'" >> '+path+'/ycseedpacket'+str(privkeycount + 1)+'/descriptor.txt', shell=True)
        ...
        subprocess.call('echo "'+pubdesc+'" >> '+path+'/ycseedpacket'+str(privkeycount + 1)+'/instructions.txt', shell=True)
