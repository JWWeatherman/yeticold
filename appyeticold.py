...
def exportdescriptorOff():
    ...
    return render_template('exportdescriptor.html', step=11, instructions="Switch to your <b>Primary Laptop</b> currently showing step 5, click next to show step 12.", laptop="Primary")
