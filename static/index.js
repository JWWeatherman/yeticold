var navbar = (yeti='cold', url) => {
  if (yeti == 'cold') {
    document.getElementById('navbar').innerHTML = '<nav class="form-row navbar navbar-light bg-primary"><img src="'+url+'" width="50" height="50" class="align-top" alt=""><h3 style="color:black;margin:0;">Yeti Bitcoin Cold Storage</h3></nav>';
  } else if (yeti == 'warm') {
