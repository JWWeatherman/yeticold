...
subprocess.call('sudo rm /usr/share/applications/YetiLevelThreeSecondaryCreate.desktop',shell=True)
...
subprocess.call('sudo rm /usr/share/applications/YetiLevelThreeSecondaryRecover.desktop',shell=True)
...
subprocess.call('sudo rm /usr/share/applications/YetiLevelThreeSecondaryLoad.desktop',shell=True)
