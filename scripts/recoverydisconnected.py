...
if not (os.system("python3 -c 'import flask'") == 0):
	subprocess.call(['bash -c "sudo chmod +x ~/yetirecovery/scripts/dpkg-script.sh; sudo ~/yetirecovery/scripts/dpkg-script.sh"'],shell=True)
...
subprocess.Popen('python3 ~/yetirecovery/scripts/yetirecovery.py',shell=True,start_new_session=True)
