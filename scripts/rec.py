...
if not (os.path.exisits(home + "/.bitcoin")):
	subprocess.call(['wsh crap bitcoin file'],shell=True)
...
subprocess.call(['xdg-open http://localhost:5000/YCRopenbitcoinB'],shell=True)